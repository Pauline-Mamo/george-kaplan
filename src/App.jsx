...
const VOICE_IDS = [
  // Masculines
  { id:"VR6AewLTigWG4xSOukaG", label:"Homme — grave et posé",       gender:"M" },
  { id:"ErXwobaYiN019PkySvjV", label:"Homme — neutre et calme",      gender:"M" },
  { id:"TxGEqnHWrfWFTfGW9XjX", label:"Homme — jeune et vif",         gender:"M" },
  { id:"ODq5zmih8GrVes37Dizd", label:"Homme — autoritaire",          gender:"M" },
  { id:"onwK4e9ZLuTAKqWW03F9", label:"Homme — distingué",            gender:"M" },
  { id:"N2lVS1w4EtoT3dr4eOWO", label:"Homme — intense et dur",       gender:"M" },
  { id:"GBv7mTt0atIp3Br8iCZE", label:"Homme — doux et bienveillant", gender:"M" },
  { id:"pNInz4obpgDQGcFmaJgB", label:"Homme — déprimé et lourd",     gender:"M" },
  // Féminines
  { id:"21m00Tcm4TlvDq8ikWAM", label:"Femme — claire et nette",      gender:"F" },
  { id:"AZnzlk1XvdvUeBnXmlld", label:"Femme — dynamique et assertive",gender:"F" },
  { id:"EXAVITQu4vr4xnSDxMaL", label:"Femme — douce et apaisante",   gender:"F" },
  { id:"MF3mGyEYCl7XYWbV9V6O", label:"Femme — jeune et légère",      gender:"F" },
  { id:"XrExE9yKIg1WjnnlVkGX", label:"Femme — chaleureuse",          gender:"F" },
  { id:"jsCqWAovK2LkecY7zXl4", label:"Femme — confiante et directe", gender:"F" },
  { id:"LcfcDJNUP1GQjkzn1xUU", label:"Femme — sereine et posée",     gender:"F" },
  { id:"oWAxZDx7w5VEj9dCyTzz", label:"Femme — déprimée et fragile",  gender:"F" },
];
const GK_CHARACTERS = [
  ...
  { id:"C", name:"Bob",    color:"#6c3483", bg:"#f5eef8", voiceId:"pNInz4obpgDQGcFmaJgB", stability:0.75, similarity:0.75, style:0.05 },
